...
function(_seir_cmake _source_dir _build_dir _install_dir)
	cmake_parse_arguments(_arg "" "STATIC_RUNTIME;TARGET" "MSVC_WARNINGS;OPTIONS" ${ARGN})
	...
	if(DEFINED _arg_STATIC_RUNTIME)
		if(_arg_STATIC_RUNTIME)
			list(APPEND _options -DCMAKE_MSVC_RUNTIME_LIBRARY=MultiThreaded$<$<CONFIG:Debug>:Debug>)
		else()
			list(APPEND _options -DCMAKE_MSVC_RUNTIME_LIBRARY=MultiThreaded$<$<CONFIG:Debug>:Debug>DLL)
		endif()
	endif()
	if(_arg_TARGET)

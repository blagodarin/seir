...
function(seir_provide_vorbis _output)
	if("vorbis" IN_LIST SEIR_3RDPARTY_SKIP)
	...
	seir_provide_ogg(_ogg_flag FLAG STATIC_RUNTIME ${_arg_STATIC_RUNTIME} SET_UPDATED _ogg_updated)
	set(_version "1.3.7")
	...
	seir_download("http://downloads.xiph.org/releases/vorbis/${_package}.tar.xz"
		...
		PATCH ${_patch}
		RESULT _downloaded)
	set(_install_dir ${SEIR_3RDPARTY_DIR}/vorbis)

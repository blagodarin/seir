...
function(seir_provide_jpeg _output)
	if("jpeg" IN_LIST SEIR_3RDPARTY_SKIP)
	...
	seir_provide_nasm(_nasm_flag FLAG SET_UPDATED _nasm_updated)
	set(_version "2.1.1")
	...
	seir_download("https://downloads.sourceforge.net/project/libjpeg-turbo/${_version}/${_package}.tar.gz"
		...
		PATCH ${_patch}
		RESULT _downloaded)
	set(_install_dir ${SEIR_3RDPARTY_DIR}/jpeg)
	if(_downloaded OR NOT EXISTS ${_install_dir} OR _nasm_updated)
		...
		if(WIN32)
			set(_extra_options -DWITH_CRT_DLL=ON) # Doesn't work, set to ON to prevent manual flag manipulation.
		else()
			set(_extra_options "")
		endif()
